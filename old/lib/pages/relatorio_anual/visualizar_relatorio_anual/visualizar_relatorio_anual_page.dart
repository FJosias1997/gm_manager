...
class VisualizarRelatorioAnualPage extends StatefulWidget {
  ...
  const VisualizarRelatorioAnualPage(
      {required this.data, required this.nomeGrupo, Key? key})
      : super(key: key);
          ...
          child: Column(
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) => DefaultFormTitleSubtitleWidget(
                  title: controller.itensData.entries
                      .elementAt(index)
                      .key
                      .split('|')[0],
                  subtitle: controller.itensData.entries
                      .elementAt(index)
                      .key
                      .split('|')[1],
                  trailing: Text(
